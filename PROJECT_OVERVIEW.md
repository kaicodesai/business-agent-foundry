...
| [PA] Scoping Agent | `E24KwVMam1e8bbjT` | 16 | Webhook POST /scope-call + poll every 2h | 🟢 Active — loop branch + blank-item guard patched 2026-04-27; latest safe smoke PASS execution 2621; AI model `qwen/qwen3.6-max-preview` |
...
| [PA] Workflow Builder Agent | `fy8OuUEGyyWhYzWC` | 21 | Polls Airtable hourly + manual | 🔴 Inactive by design — patched 2026-04-27 to current build.in_progress/build.complete/build.blocked flow; 0 eligible build.ready clients; AI model `deepseek/deepseek-v4-pro` |
